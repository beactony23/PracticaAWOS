...
const API = "https://knife-effort-naval-vision.trycloudflare.com/4B/Api-GitHub/PracticaAWOS/CURSOS/"
$(document).ready(function () {
    ...
    $("#formCurso").submit(function (e) {
        ...
        $.post(`${API}datos.php`, datos + "&" + accion, function (res) {
    ...
    $(document).on("click", ".btn-editar", function () {
        ...
        $.get(`${API}datos.php`, { id_mod: id }, function (res) {
    ...
    $(document).on("click", ".btn-eliminar", function () {
        ...
        if (confirm("¿Seguro que quieres eliminar este curso?")) {
            $.get(`${API}datos.php`, { id_eliminar: id }, function (res) {
                listarCursos();
            });
        }
    });
